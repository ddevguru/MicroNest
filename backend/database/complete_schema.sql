-- MicroNest Complete Database Schema
-- Create database
...
CREATE TABLE transactions (
    ...
    user_id INT NOT NULL,
    group_id INT NULL,
    transaction_type ENUM('contribution', 'withdrawal', 'loan', 'payment', 'deposit') NOT NULL,
    amount DECIMAL(10,2) NOT NULL,
...
CREATE INDEX idx_group_contributions_group_date ON group_contributions(group_id, contribution_date);
CREATE INDEX idx_loans_user_status ON loans(user_id, status);
CREATE INDEX idx_notifications_user_read ON notifications(user_id, read_status);
CREATE INDEX idx_group_members_total_contributed ON group_members(total_contributed);
CREATE INDEX idx_savings_groups_total_funds ON savings_groups(total_funds); 