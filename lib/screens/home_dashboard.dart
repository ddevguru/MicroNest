...
// - Withdraw: Icons.account_balance_wallet (Wallet/Withdraw icon)
// - Transactions: Icons.receipt_long (Receipt/Transaction icon)
// - Notifications: Icons.notifications (Bell/Notification icon)
// - Settings: Icons.settings (Gear/Settings icon)
// - Profile: Icons.person (Profile icon)
// - Empty State: Icons.inbox (Empty icon)
// - Loading State: Lottie animation
// - History: Icons.history (History icon)
// - Insights: Icons.analytics (Analytics icon)
...
class _HomeDashboardState extends State<HomeDashboard> with TickerProviderStateMixin {
      ...
      if (mounted) {
        setState(() {
          ...
          if (dashboardResult['success']) {
            ...
            recentActivities = dashboardResult['recent_activities'] ?? [];
          }
          isLoading = false;
        });
      }
  ...
  Widget _buildLoadingState() {
    return Center(
      child: Column(
        ...
        children: [
          Lottie.asset(
            'assets/animations/loading.json', // Assume Lottie file for loading
            width: 100,
            height: 100,
          ),
          const SizedBox(height: 20),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Right side - Profile, Notification and Settings Icons
          Row(
            children: [
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to proceed with withdrawal? This action cannot be undone.',
            style: TextStyle(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Withdrawal process started!'),
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Column(
            ...
            children: [
              Text(
                'Select loan type and amount to proceed.',
                style: TextStyle(
                  color: Colors.white70,
                  fontSize: 16,
                ),
              ...
              SizedBox(height: 10),
              Text(
                'Quick options: Personal (up to Rs. 5000), Group (up to Rs. 2000)',
                style: TextStyle(
  ...
  Widget _buildRecentActivitySection() {
    if (_slideAnimation == null || _fadeAnimation == null) {
      return _buildRecentActivitySectionWithoutAnimation();
    }
    ...
    return SlideTransition(
      ...
      child: FadeTransition(
        ...
        child: AnimatedContainer(
          ...
          child: _buildRecentActivitySectionContent(),
        ),
      ),
    );
  }

  Widget _buildRecentActivitySectionWithoutAnimation() {
    return _buildRecentActivitySectionContent();
  }

  Widget _buildRecentActivitySectionContent() {
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              // Lottie.asset(
              //   'assets/animations/empty.json', // Assume Lottie for empty state
              //   width: 80,
              //   height: 80,
              // ),
              const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            DashboardService.formatLargeCurrency(amount),
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.bold,
              color: iconColor,
  ...
  Widget _buildInsightsSection() {
    if (_slideAnimation == null || _fadeAnimation == null) {
      return _buildInsightsSectionWithoutAnimation();
    }
    ...
    return SlideTransition(
      ...
      child: FadeTransition(
        ...
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 800),
          curve: Curves.easeOutBack,
          child: _buildInsightsSectionContent(),
        ),
      ),
    );
  }

  Widget _buildInsightsSectionWithoutAnimation() {
    return _buildInsightsSectionContent();
  }

  Widget _buildInsightsSectionContent() {
    // Mock insights data (replace with actual data from service)
    final insights = [
      {
      ...
      },
      {
        'title': 'Savings Goal',
        'value': '75%',
        'description': 'You\'re close to your target!',
        'icon': Icons.savings,
        'color': const Color(0xFF52B788),
      },
    ];
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: (insight['color'] as Color).withOpacity(0.5),
                width: 1,
              ),
            ),
            child: Icon(
...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final accentPaint = Paint()
      ..color = const Color(0xFF52B788).withOpacity(0.05)
      ..style = PaintingStyle.fill;
